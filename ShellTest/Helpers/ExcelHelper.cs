    ...
    public class ExcelHelper
    {
        ...
        public string getExcelSheetName(string xlFilePath, int index)
        {
            ...
            try
            {
                ...
                xl.Worksheet worksheet = (xl.Worksheet)sheets.get_Item(index);//Get the reference of second worksheet
            ...
            int ColNumber, String dataToWrite)
        {
            ...
            GenericHelper.WriteLog(driver, filepath, " Data--> (" + dataToWrite + ") added successfully at Column Number-> " + ColNumber + " and Row Number ->" + RowNumber);
        ...
        public static void readExcel(IWebDriver driver, String filepath, String fileName)
        {
            ...
            Worksheet worksheet = wb.Worksheets[0];
            Cells cells = worksheet.Cells;
            GenericHelper.WriteLog(driver, filepath, "Reading Excel contents of file " + filepath + "\\" + fileName + "   are :-");
            ...
            GenericHelper.WriteLog(driver, filepath, "Data Read Successfully");
            //**********************************not working for ***********************************
            ...
            int eRowNumber, int sColNumber, int eColNumber)
        {
            ...
            GenericHelper.WriteLog(driver, filepath, "Inside method readExcelrowcolumnwise\n \n");
            GenericHelper.WriteLog(driver, filepath, "********************************************");
            string s = null;
            Workbook wb = new Workbook(filepath + "\\" + fileName);
            Worksheet worksheet = wb.Worksheets[0];
            ...
            for (int i = sRowNumber; i <= eRowNumber; i++)
            {
                for (int j = sColNumber; j <= eColNumber; j++)
                {
                    ...
                    GenericHelper.WriteLog(driver, filepath, "Excel data for Row Number ->" + i + " and Column Number " + j + " is :" + s);
                }
            }
            GenericHelper.WriteLog(driver, filepath, "Data Read Successfully \n \n");
            return s;
        ...
        public static string ReaddataonmultiplesheetExcelrowcolumnwise(IWebDriver driver, String filepath, String fileName, int sRowNumber, int eRowNumber, int sColNumber, int eColNumber, string SheetName)
        {
            ...
            //********************************
            GenericHelper.WriteLog(driver, filepath, "**************************************");
            GenericHelper.WriteLog(driver, filepath, "Inside method ReaddataonmultiplesheetExcelrowcolumnwise \n \n");
            GenericHelper.WriteLog(driver, filepath, "********************************************");
            string s = null;
            Workbook wb = new Workbook(filepath + "\\" + fileName);
            ...
            for (int i = sRowNumber; i <= eRowNumber; i++)
            {
                for (int j = sColNumber; j <= eColNumber; j++)
                {
                    //       s = cells[i, j].StringValue.Trim();
                    s = Convert.ToString(cells[i, j].StringValue.Trim());
                    GenericHelper.WriteLog(driver, filepath, "Actual Excel data for Row Number ->" + i + " and Column Number " + j + " in Sheet  is :" + s);
                }
            }
            GenericHelper.WriteLog(driver, filepath, "Data Read Successfully \n \n");
            return s;
        ...
        public static bool verifydataonmultiplesheetExcelrowcolumnwise(IWebDriver driver, String filepath, String fileName, int sRowNumber, int eRowNumber, int sColNumber, int eColNumber, string SheetName, string texttoverify)
        {
            ...
            bool result = false;
            GenericHelper.WriteLog(driver, filepath, "**************************************");
            GenericHelper.WriteLog(driver, filepath, "Inside method verifydataonmultiplesheetExcelrowcolumnwise \n \n");
            GenericHelper.WriteLog(driver, filepath, "********************************************");
            string s = null;
            Workbook wb = new Workbook(filepath + "\\" + fileName);
            Worksheet worksheet = wb.Worksheets[SheetName];
            ...
            for (int i = sRowNumber; i <= eRowNumber; i++)
            {
                for (int j = sColNumber; j <= eColNumber; j++)
                {
                    ...
                    {
                        GenericHelper.WriteLog(driver, filepath, "Actual Excel Data for Row Number ->" + i + " and Column Number -->" + j + " is :[" + s + "] &  Expected data is -->[" + texttoverify + "]. Hence ,verification is Passed ");
                        return true;
                    }
                    else
                    {
                        GenericHelper.WriteLog(driver, filepath, "Actual Excel Data for Row Number ->" + i + " and Column Number -->" + j + " is :[" + s + "] &  Expected data -->[" + texttoverify + "]. Hence ,verification is failed ");
        ...
        {
            GenericHelper.WriteLog(driver, filepath, "**********************");
            GenericHelper.WriteLog(driver, filepath, "Inside method Readfromcsv");
            GenericHelper.WriteLog(driver, filepath, "***********************");
            ...
            try
            {
                using (CsvReader csv = new CsvReader(new StreamReader(@filepath + "\\" + filename + ".csv"), true))
                {
                    ...
                    for (i = 0; i <= fieldCount - 1; i++)
                    {
                        ...
                        GenericHelper.WriteLog(driver, filepath, "Column names present in csv at index ->" + Convert.ToString(i) + " is ->: " + headers[i]);
                        ...
                        GenericHelper.WriteLog(driver, filepath, headers[i] + " is present at column index " + Convert.ToString(idx));
                        if (headers[i].Contains(header))
                        {
                            while (csv.ReadNextRecord())
                            {
                                ...
                                {
                                    GenericHelper.WriteLog(driver, filepath, "  Data present in CSV in Column Header ->" + header + "  are--> " + item);
                                }
                            }
                        }
                    }
        ...
        public static void Readcsvcolumnnamerownumberwise(IWebDriver driver, string csvfilepath, string csvfilename, string header, int rownumber)
        {
            GenericHelper.WriteLog(driver, filepath, "**********************");
            GenericHelper.WriteLog(driver, filepath, "Inside method Readfromcsvcolumnnamerownumberwise");
            GenericHelper.WriteLog(driver, filepath, "***********************");
            TextReader textReader = null;
            List<string> columns = new List<string>();
                            ...
                            for (c = 0; c <= fieldCount - 1; c++)
                            {
                              ...
                              //  if (headers[c].Contains(header))
...

                                {
                                    ...
                                    GenericHelper.WriteLog(driver, csvfilepath, "Data present in CSV at  Row [" + r + "] Column [ " + header + " ] has value -->[ " + al[r, c] + "]");


                                    headers = csv.GetFieldHeaders();
                                  //  GenericHelper.WriteLog(driver, csvfilepath, "Column names present in csv are ->" + Convert.ToString(c) + ": " + headers[c]);


                                    GenericHelper.WriteLog(driver, csvfilepath, "Column names present in csv at index ->" + Convert.ToString(c) + " is ->: " + headers[c]);

                                    //  The following line demonstrates  to get the column index given a column name:
                                    idx = csv.GetFieldIndex(headers[c]);

                                   GenericHelper.WriteLog(driver, csvfilepath, headers[c] + "->is present at column index -->" + Convert.ToString(idx));
        ...
        public static void Readfromcsvrowcolumnwise(IWebDriver driver, string csvfilepath, string csvfilename, int srownum, int erownum, int scolnum, int ecolnum)
        {
            ...
            GenericHelper.WriteLog(driver, csvfilepath, "Inside method Readfromcsvrowrowcolumnwise \n \n");
            GenericHelper.WriteLog(driver, csvfilepath, "***********************");
            string FileLines = System.IO.File.ReadAllText(@csvfilepath + "\\" + csvfilename + ".csv");
            // Split into lines.
            FileLines = FileLines.Replace('\n', '\r');
            ...
            for (int r = srownum; r <= erownum; r++)
            {
                ...
                for (int c = scolnum; c <= ecolnum; c++)
                {
                    al[r, c] = line_r[c];
                    al1.Add(al[r, c]);
                    //    GenericHelper.WriteLog(driver, csvfilepath, "  Data present in CSV at  Row [" + r + "] Column [ " + c + " ] has value -->[ " + al1[r, c] + "]");
                    GenericHelper.WriteLog(driver, csvfilepath, "  Data present in CSV at  Row [" + r + "] Column [ " + c + " ] has value -->[ " + al[r, c] + "]");
                }
            }
        }
        ...
        {
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Inside method csvcompare ");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            ...
            for (int i = 0; i < fileContentsOne.Length; i++)
            {
                ...
                {
                    GenericHelper.WriteLog(driver, destinationcsvfilepath, "  Data present in CSV1 at row [ " + i + " ] has value -->[ " + columnsOne[j] + " ]");
                    GenericHelper.WriteLog(driver, destinationcsvfilepath, "  Data present in CSV2 at row [ " + i + " ] has value -->[ " + columnsTwo[j] + " ]");
                    if (columnsOne[j].Equals(columnsTwo[j])) //if line 1 equals line 2
                    {
                        GenericHelper.WriteLog(driver, destinationcsvfilepath, " No differences found"); //no differences found
                        continue;
                    }
                    else if (!columnsOne[j].Equals(columnsTwo[j]))
                    {
                        GenericHelper.WriteLog(driver, destinationcsvfilepath, " Differences found at Line Number [ " + i + " ] "); //no differences found
        ...
        {
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Inside method csvComparerowcolumnnwise");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            //CSV 1 
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Reading CSV1 Data");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            ...
            {
                GenericHelper.WriteLog(driver, @sourcecsvfilepath, " Reading Row ->" + i + "in CSV 1 ");
                num_colsone = linesone[i].Split(',').Length;
                GenericHelper.WriteLog(driver, @sourcecsvfilepath, " Number of columns in CSV 1 at Row  ->" + i + " are " + num_colsone);
            ...
            for (int r1 = sourcesrownum; r1 <= sourceerownum; r1++)
            {
                ...
                for (int c1 = sourcescolnum; c1 <= sourceecolnum; c1++)
                {
                    ...
                    al1.Add(al[r1, c1]);
                    //    GenericHelper.WriteLog(driver, csvfilepath, "  Data present in CSV at  Row [" + r + "] Column [ " + c + " ] has value -->[ " + al1[r, c] + "]");
                    GenericHelper.WriteLog(driver, @sourcecsvfilepath, "  Data present in CSV1 at  Row [ " + r1 + " ] Column [ " + c1 + " ] has value -->[ " + al[r1, c1] + " ]");
                }
            }
            //CSV 2
            bool result = false;
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Reading CSV2 Data");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            ...
            {
                GenericHelper.WriteLog(driver, @destinationcsvfilepath, " Reading Row ->" + j + "in CSV2 ");
                num_colstwo = linestwo[j].Split(',').Length;
                GenericHelper.WriteLog(driver, @destinationcsvfilepath, " Number of columns in CSV 2 at Row  ->" + j + " are " + num_colstwo);
            ...
            for (int r2 = destinationsrownum; r2 <= destinationerownum; r2++)
            {
                ...
                for (int c2 = destinationscolnum; c2 <= destinationecolnum; c2++)
                {
                    ...
                    all1.Add(all[r2, c2]);
                    //    GenericHelper.WriteLog(driver, csvfilepath, "  Data present in CSV at  Row [" + r + "] Column [ " + c + " ] has value -->[ " + al1[r, c] + "]");
                    GenericHelper.WriteLog(driver, destinationcsvfilepath, "  Data present in CSV2 at  Row [ " + r2 + " ] Column [ " + c2 + " ] has value -->[ " + all[r2, c2] + " ]");
                }
            }
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Comparison of CSV1 & CSV2  Starts \n \n");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            ...
            //}
            GenericHelper.WriteLog(driver, destinationcsvfilepath, "Data Comparison between CSV1 [" + sourcecsvfilename + " ] and CSV2  [ " + destinationcsvfilename + " ] is-- >  [ " + result3 + " ]");
            if (al3.Contains("Fail"))
            {
                GenericHelper.WriteLog(driver, destinationcsvfilepath, "Data Comparison between CSV1 [" + sourcecsvfilename + " ] and CSV2  [ " + destinationcsvfilename + " ]  is failed ");
                throw new Exception("Data Comparison between CSV1 [" + sourcecsvfilename + " ] and CSV2  [ " + destinationcsvfilename + " ]  is failed ");
                return false;
            }
            else
            {
                GenericHelper.WriteLog(driver, destinationcsvfilepath, "Data Comparison between CSV1 [" + sourcecsvfilename + " ] and CSV2  [ " + destinationcsvfilename + " ]  is Passed ");
                return true;
            }
            return result;
        }
        ...
        {
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Inside method csvCompareexcel \n \n");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "**********************");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "Reading CSV Data \n\n ");
            GenericHelper.WriteLog(driver, sourcecsvfilepath, "***********************");
            //CSV 1 
            //     string FileLinesone = System.IO.File.ReadAllText(@sourcecsvfilepath + "\\" + sourcecsvfilename + ".csv");
            // Split into lines.
            ...
            for (int i = 0; i < num_rowsone; i++)
            {
                // GenericHelper.WriteLog(driver, @sourcecsvfilepath, " Reading Row ->" + i + "in CSV  ");
                num_colsone = linesone[i].Split(',').Length;
                //   GenericHelper.WriteLog(driver, @sourcecsvfilepath, " Number of columns in CSV  at Row  ->" + i + " are " + num_colsone);
                if (max_num_colsone < num_colsone)
                {
                    max_num_colsone = num_colsone;
                }
            ...
            for (int r1 = sourcesrownum; r1 <= sourceerownum; r1++)
            {
                ...
                for (int c1 = sourcescolnum; c1 <= sourceecolnum; c1++)
                {
                    ...
                    al1.Add(al[r1, c1]);
                    //    GenericHelper.WriteLog(driver, csvfilepath, "  Data present in CSV at  Row [" + r + "] Column [ " + c + " ] has value -->[ " + al1[r, c] + "]");
                    GenericHelper.WriteLog(driver, @sourcecsvfilepath, "  Data present in CSV ->[" + sourcecsvfilename + " ] at  Row [ " + r1 + " ] Column [ " + c1 + " ] has value -->[ " + al[r1, c1] + " ]");
                }
            }
            //Reading EXCEL
            //*********************************************
            //     using aspose.cells
            //************************************************
            GenericHelper.WriteLog(driver, destinationfilepath, "**************************************");
            GenericHelper.WriteLog(driver, destinationfilepath, "Reading Excel Data \n \n");
            GenericHelper.WriteLog(driver, destinationfilepath, "********************************************");
            string s = null;
            ...
            //    Worksheet worksheet = wb.Worksheets[0];
            Cells cells = worksheet.Cells;
            GenericHelper.WriteLog(driver, destinationfilepath, "Reading Excel contents of file " + destinationfilepath + "\\" + destinationfilename + "   are :-");
            GenericHelper.WriteLog(driver, destinationfilepath, "**************************************");
            ...
            for (int i = destinationsrownum; i <= destinationerownum; i++)
            {
                for (int j = destinationscolnum; j <= destinationecolnum; j++)
                {
                    //       s = cells[i, j].StringValue.Trim();
                    s = Convert.ToString(cells[i, j].StringValue.Trim());
                    GenericHelper.WriteLog(driver, destinationfilepath, "Data Present in Excel [ " + destinationfilename + " ] at  Row Number ->[ " + i + " ] and Column Number[ " + j + " ] in Sheet [ " + SheetName + " ]  is :-->[ " + s + " ]");
                    al2.Add(s);
                }
            }
            GenericHelper.WriteLog(driver, destinationfilepath, "Data Read Successfully \n \n");
            //Comparison of CSV & Excel  Starts
            GenericHelper.WriteLog(driver, destinationfilepath, "**************************************");
            GenericHelper.WriteLog(driver, destinationfilepath, "Comparison of CSV & Excel  Starts \n \n");
            GenericHelper.WriteLog(driver, destinationfilepath, "*******************************************");
            List<string> al3 = new List<string>();
            string result1 = null;
            string result2 = null;
            ...
            for (int i = 0; i < al1.Count; i++)
            {
                ...
                GenericHelper.WriteLog(driver, destinationfilepath, "Data Comparison between CSV [" + sourcecsvfilename + " ] and Excel  [ " + destinationfilename + " ] for Data [ " + al1[i] + " ] is-- >  [ " + result3 + " ]");
            }
            if (al3.Contains("Fail"))
            {
                GenericHelper.WriteLog(driver, destinationfilepath, "********************************************\n\n");
                GenericHelper.WriteLog(driver, destinationfilepath, "Data Comparison between CSV [" + sourcecsvfilename + " ] and Excel  [ " + destinationfilename + " ]  is failed \n\n ");
                GenericHelper.WriteLog(driver, destinationfilepath, "********************************************\n\n");
            ...
            {
                GenericHelper.WriteLog(driver, destinationfilepath, "********************************************\n\n");
                GenericHelper.WriteLog(driver, destinationfilepath, "Data Comparison between CSV [" + sourcecsvfilename + " ] and Excel  [ " + destinationfilename + " ]  is Passed \n\n ");
                GenericHelper.WriteLog(driver, destinationfilepath, "********************************************\n\n");
                return true;
            }
            return result;
